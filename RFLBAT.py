...
from models.RFLBAT import RFLBAT
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_encoder', default='./result/fed_pretrain_encoder/fed_pretrain_encoder_cifar100_v2200.pth', type=str,
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        # """Flame"""
        # print('='*20,'Flame','='*20)
        # update_w = flame(local_weights, grad_list, global_para,attacker_num_choice,args)
        # global_model.load_state_dict(update_w)

        """RFLBAT"""
        print('='*20,'RFLBAT','='*20)
        update_w = RFLBAT(grad_list, local_weights,_)
        global_model.load_state_dict(update_w)
        # """Our EmbInspector"""
        # print('========== EmbInspector ==========')
        #
